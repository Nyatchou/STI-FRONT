...
export class AdminActionsService {
  ...
  getChaptersFromCourses(courseId: string): Observable<any> {
    return this.http.get<any>(URLS.GET_CHAPTERS_FROM_COURSE_URL);
  }
