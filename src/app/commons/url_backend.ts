...
export const CREATE_CHAPTER_URL = HOST_URL + '/api/createchap/';
export const CREATE_PARTCHAPTER_URL = HOST_URL + '/api/createpartchap/';

export const CREATE_COURSE_URL = HOST_URL + '/api/course/';
export const CREATE_SECTIONCOURSE_URL = HOST_URL + '/api/sectioncourse/create/';
export const GET_DOMAINS_LIST_URL = HOST_URL + '/api/domains/';
export const GET_COURSES_FROM_DOMAIN_URL = HOST_URL + '/api/courses/';
